 ...
 */}
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
          ...
          <View style={styles.songBox}>
            ...
            <View style={styles.playButtonBox}>
              <TouchableOpacity style={styles.playButton} onPress={() => navigation.navigate('Play Disliked Playlist Screen')
      ...
      <Image style={styles.gradient} source={require('../assets/Images/DislikedGradient.png')} />
